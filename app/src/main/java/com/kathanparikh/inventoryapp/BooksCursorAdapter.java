...
public class BooksCursorAdapter extends CursorAdapter{
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        int productIdColumIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry._ID);
        ...
        saleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri currentUri = ContentUris.withAppendedId(BooksBoxContract.BooksBoxEntry.CONTENT_URI, productIdVal);

                String updatedQuantity = String.valueOf(currentProductQuantityVal - 1);

                if(Integer.parseInt(updatedQuantity)>=0){
                    ContentValues values = new ContentValues();
                    values.put(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_QUANTITY,updatedQuantity);
