package com.kathanparikh.inventoryapp;
...
import com.kathanparikh.inventoryapp.data.BooksBoxContract;
import com.kathanparikh.inventoryapp.data.BooksBoxDbHelper;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveBook() {
        ...
        values.put(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_NAME, productNameString);
        values.put(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_PRICE, productPriceInt);
        values.put(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_QUANTITY, productQuantityInt);
        values.put(BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_NAME, supplierNameString);
        values.put(BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_PHONE_NUMBER, supplierContactString);

        // Determine if this is a new or existing book by checking if currentBookUri is null or not
        if (currentBookUri == null) {
            // This is a NEW book, so insert a new book into the provider,
            // returning the content URI for the new book.
            Uri newUri = getContentResolver().insert(BooksBoxContract.BooksBoxEntry.CONTENT_URI, values);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                BooksBoxContract.BooksBoxEntry._ID,
                BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_NAME,
                BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_PRICE,
                BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_QUANTITY,
                BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_NAME,
                BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_PHONE_NUMBER,
        };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int productNameColumnIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_NAME);
            int productPriceColumnIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_PRICE);
            int productQuantityColumnIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry.COLUMN_PRODUCT_QUANTITY);
            int supplierNameColumnIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_NAME);
            int supplierContactColumnIndex = cursor.getColumnIndex(BooksBoxContract.BooksBoxEntry.COLUMN_SUPPLIER_PHONE_NUMBER);
